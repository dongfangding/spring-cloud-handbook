 ...
 */
@FeignClient(name = UserConst.SERVICE_NAME, path = "/userInfo", contextId = "clubInfoFacade")
public interface AppUserInfoFacade {
    ...
    EmailRegistryValidateResponse checkRegistryInfo(@RequestBody @Validated EmailRegistryValidateRequest request);
    ...
    Boolean registry(@RequestBody @Validated EmailRegistryRequest request);
    ...
    List<UserInfoDTO> searchUser(@Validated SearchUserRequest request);
